...
public class LoginActivity extends Activity  implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //google버튼모양
        binding.google.setSize(SignInButton.SIZE_WIDE);
    ...
    public void onLogin(){
        ...
        showPd();
        String email = binding.edit1.getText().toString();
    ...
    public boolean isVaild(){
        ...
        if(TextUtils.isEmpty(email)){
            binding.edit1.setError("이메일을 입력하세요.");
            return false;
        }
        if(TextUtils.isEmpty(password)){
            binding.edit2.setError("비밀번호를 입력하세요.");
            return false;
        }
